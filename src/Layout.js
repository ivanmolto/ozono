...
import rss3 from "./rss3.svg";
import ozono from "./ozono.svg";
                ...
                <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-sky-700">
                  ...
                  >
                    <div className="px-2 space-y-1">
                      ...
                      <ul>
                        <CustomLink to="/donationprofiler">
                          <ScaleIcon
                            className="mr-4 flex-shrink-0 h-6 w-6 text-white"
                            aria-hidden="true"
                          />
                      ...
                      <ul>
                        <CustomLink to="/governanceprofiler">
                          <ChatAlt2Icon
                            className="mr-4 flex-shrink-0 h-6 w-6 text-white"
                            aria-hidden="true"
                          />
                    ...
                    <div className="mt-6 pt-6">
                      <div className="px-2 space-y-1">
                        ...
                        <a
                          ...
                          rel="noreferrer"
                          target="_blank"
                          href="https://twitter.com/ozono_app"
                          className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-white hover:text-white hover:bg-sky-600"
                        >
                          <svg
                            fill="currentColor"
        ...
        <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
          <div className="flex flex-col flex-grow bg-sky-400 pt-5 pb-4 overflow-y-auto ">
            ...
            <div className="flex-shrink-0 flex justify-around items-center px-4 mb-4">
              <a href="https://www.rss3.io" rel="noreferrer" target="_blank">
                <img className="h-4/5 w-4/5" src={rss3} alt="Powered by Rss3" />
              </a>
            </div>
            <div className="flex-shrink-0 flex justify-around items-center px-4">
              <a href="https://www.knn3.xyz" rel="noreferrer" target="_blank">
                <img className="h-4/5 w-4/5" src={knn3} alt="Powered by Knn3" />
              </a>
            </div>
          </div>
        </div>
